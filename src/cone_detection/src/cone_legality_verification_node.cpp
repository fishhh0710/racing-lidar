...
{
    std::cout<<"Receive pcl successfully\n";
...
{   
    std::cout<<"start running cone detection...\n";
    // ros::ROS_INFO("Start running cone_detection");
    ros::init(argc, argv, "cone_detection");
    ros::NodeHandle nh;

    ros::Subscriber sub = nh.subscribe<sensor_msgs::PointCloud2>("/downsampled_cloud", 1, coneReconstruction); ///ground_segmentation/obstacle_cloud->downsampled_cloud
